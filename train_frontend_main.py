...
class TrainControlUI(QMainWindow):
    ...
    def _updateAdImage(self) -> None:
        ...
        try:
            ...
            pass
        self.adsLabel.setPixmap(QPixmap())
        self.adsLabel.setText("PEPSI AD")
        self.adsLabel.setFont(QFont("Segoe UI", 20, QFont.Weight.Bold))
        self.adsLabel.setStyleSheet("color: #005CB4; background: transparent; border: none;")
