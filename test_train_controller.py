...
========================
Full unit-test suite for TrainController (train_controller_backend.py).
Place this file in the SAME folder as train_controller_backend.py and run:

    python -m pytest test_train_controller.py -v
  OR
    python test_train_controller.py

All 40 test cases are self-contained — no external files or hardware needed.
"""
